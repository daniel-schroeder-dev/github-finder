  ...
  render() {
    ...
    return (
      <form className="search-bar" onSubmit={this.handleSubmit}>
        ...
        <input className="search-bar__search-input" type="text" name="search" value={this.state.searchValue} onChange={this.handleChange} placeholder="Search users" autoComplete="off" autoFocus />
        <div>
